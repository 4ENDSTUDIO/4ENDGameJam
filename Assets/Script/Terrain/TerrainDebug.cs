...
{
    [Header("Template")]
    public List<TerrainControl> terrainTemplates;
    public float terrainTemplateWidth;

    [Header("Force Early Template")]
    public List<TerrainControl> earlyTerrainTemplater;
    ...
    private void Start()
    {
        ...
        foreach (TerrainControl terrain in earlyTerrainTemplater)
        {
    ...
    private void GenerateTerrain(float posX, TerrainControl forceTerrain = null)
    {
